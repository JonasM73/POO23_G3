...
void NS_Comp_SvcClient::CLservices::UpdateUnePersonne(System::String^ num, System::String^ nom, System::String^ prenom, System::DateTime^ DNN, System::DateTime^ D_Pachat, System::String^ AP_L, System::String^ AP_F, int CP_L, int CP_F, System::String^ ville_l, System::String^ ville_f)
{
	System::String^ sql;
	this->serviceClient->setnumero_client(num);
	this->serviceClient->setnom_client(nom);
